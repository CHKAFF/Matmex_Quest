...
namespace MATMEH_QUEST.Domain
{
    public class World
    {
        ...
        public World()
        {
            ...
            Doors[0] = new Door(Door.DoorState.Open, new Room(Resources.Деканат_задание, new List<Human>(){new Human(Human.HumanState.Ready, 0, new Point(1000, 1), new List<Item>())}, new List<Item>()),new Point(7040, 0) );
