...
namespace MATMEH_QUEST.Domain
{
    public class World
    {
        ...
        public World()
        {
            ...
            Doors[1] = new Door(Door.DoorState.Close, new Room(Resources.Комната601_задание, new List<Human>{new Human(Human.HumanState.Ready, 1, new Point(860, 1), new List<Item>())}, new List<Item>()),new Point(1050, 0) );
        }
    }
